# -*- coding: utf-8 -*-
#
# _komoog documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../'))
sys.path.insert(0, os.path.abspath('../komoog/'))
...
man_pages = [
    (master_doc, 'komoog', u'komoog Documentation',
     [author], 1)
]
